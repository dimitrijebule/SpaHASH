 ...
 * vodjenjem raÄ�una o tome kako se podaci smeÅ¡taju u okviru skupa, Å¡to moÅ¾e
 * pomoÄ‡i da se bolje oceni kvalitet funkcije `hashCode` za konkretne objekte u
 * skupu.
 *
 * http://perun.dmi.rs
 *
 * @param <E>
 *            Tip objekata koji Ä‡e biti Ä�uvani u skupu
 */
public class StatSet<E> extends AbstractSet<E> {

	private final HashSet<E> set = new HashSet<E>();
	private final HashMap<Integer, Integer> count = new HashMap<Integer, Integer>();
